...
logging.basicConfig()
logger = logging.getLogger('MFOptimizerCS')
logger.setLevel('INFO')


class MFOptimizerCS(CuckooSearch):

    def __init__(self, **kwargs):
        super(MFOptimizerCS, self).__init__(**kwargs)
    ...
    def cost_function(self, position):
        ...
        self.eval_count += 1
        return super(MFOptimizerCS, self).cost_function(position)
...
if __name__ == '__main__':
    ...
    optimizer_cs = MFOptimizerCS(func=optimized_cs, iterations=200)
